...
If you see mermaid markup here, you better go to [the JavaScript README page on GitHub to see actual rendering](https://github.com/link-foundation/log-lazy/blob/main/js/README.md#-benchmarks).
